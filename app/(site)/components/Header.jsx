        ...
        <div className='flex bg-black gap-12 lg:flex-row flex-col items-center'>
            <div>
                ...
                <div className='flex bg-white rounded-b-lg w-full p-3'>
                    ...
                    <Link href={{pathname: '/properties', query: {type: selection}}} className='ml-3 my-1 flex-1 sm:flex hidden bg-blueText whitespace-nowrap text-primaryText px-3 rounded-lg text-lg font-semibold items-center hover:opacity-90 justify-center'>
