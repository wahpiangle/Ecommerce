...
const Navbar = ({currentUser}) => {
    ...
    return (
        <nav className='flex bg-primary w-full py-4 px-6 justify-between items-center'>
            ...
            <div className='flex text-primaryText text-lg gap-8 items-center'>
                <Link href='/rent' className='cursor-pointer hover:opacity-75'>Rent</Link>
                <Link href='/buy' className='cursor-pointer hover:opacity-75'>Buy</Link>
                <Link href='/dashboard' className='cursor-pointer flex items-center gap-2 bg-blueText py-2 px-3 hover:opacity-75 rounded-lg'>
                    <FaHouseUser/>
