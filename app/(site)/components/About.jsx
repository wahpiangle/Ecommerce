    ...
    return (
        <div className='text-primaryText mt-24 flex lg:flex-row flex-col gap-8 sm:gap-16 bg-primary rounded-lg  sm:p-12 p-6'>
            ...
            <div>
                ...
                <p className='text-secondaryText mt-1 md:mt-4 sm:mt-2 sm:text-md text-sm'>
                ...
                <div className='flex gap-4 mt-6'>
                    <Link href={{pathname: '/properties', query: {type: 'purchase'}}}>
                        <button className='bg-blueText text-primaryText rounded-lg py-2 px-4 text-lg hover:opacity-50 font-semibold'>Purchase</button>
                    </Link>
                    <Link href={{pathname: '/properties', query: {type: 'rent'}}} className='hover:opacity-75 bg-secondaryText text-primaryText rounded-lg'>
                        <button className=' rounded-lg py-2 px-4 text-lg font-semibold'>Rent</button>
                    </Link>
                </div>
            </div>
        </div>
